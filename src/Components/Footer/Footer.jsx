    ...
    <footer className="w-full  mx-auto px-4 sm:px-6 lg:px-8 py-10 border-t border-gray-200 bg-gradient-to-r from-gray-400 via-gray-300 to-gray-200 mt-auto ">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-3">
            <li>
              <a href="/about" className="text-sm sm:text-base text-gray-600 hover:text-blue-600 transition duration-300">
                About Us
              </a>
            </li>
            <li>
              <a href="/services" className="text-sm sm:text-base text-gray-600 hover:text-blue-600 transition duration-300">
                Services
              </a>
            </li>
            <li>
              <a href="/contact" className="text-sm sm:text-base text-gray-600 hover:text-blue-600 transition duration-300">
                Contact
              </a>
            </li>
          </ul>
