      ...
      <div className="max-w-[1300px] mx-auto">
        ...
        <section className="py-12 px-4 md:px-10 lg:px-20 bg-gray-200 font-title">
          <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-10">
            {/* Left Content */}
            <div className="text-center lg:text-left max-w-3xl bg-white/60 backdrop-blur-lg p-8 rounded-3xl shadow-xl border border-purple-100">
              <h2 className="text-2xl sm:text-4xl lg:text-5xl font-extrabold mb-6 tracking-tight">
                Our Core Vision
              </h2>
              <p className="text-gray-700 text-lg leading-relaxed mb-8">
                <span className="text-purple-900 font-bold underline decoration-purple-300">
                  Get started
                </span>{" "}
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="flex justify-center px-4 sm:px-6 lg:px-20 py-2">
              <div className="shadow-xl rounded-2xl p-8 sm:p-10 max-w-6xl w-full text-center border border-purple-200">
                ...
                <p className="text-gray-900 text-lg leading-relaxed">
                  ...
                  through Divine Magic Healing Space. These heartfelt stories
                  reflect the journey of healing, self-discovery, and personal
                  growth.
                </p>
              </div>
            </div>
